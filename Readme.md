...
Panda 大语言模型目前立足于 Llama-7B,  -13B，-65B 架构, 并在大量开源中文文本数据集上面进行了大规模训练和优化。Panda 语言模型更注重覆盖全球华人使用场景，并致力于提供高质量的中文语言模型，使得全球华人能够更加便捷地进行各种自然语言处理任务。未来会切换到新的底座模型或者训练自己的底座模型。
